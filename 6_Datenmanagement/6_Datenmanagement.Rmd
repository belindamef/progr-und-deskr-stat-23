...
knitr::include_graphics("6_Abbildungen/pds_6_otto.png")
```
...
27.01.2022   & Deskriptive Statistik       & (14) Q \& A                                 \\\hline
...
knitr::include_graphics("6_Abbildungen/pds_6_data.pdf")
```
\end{minipage}
...
\begin{center}
```{r, echo = FALSE, out.width = "60%"}
knitr::include_graphics("6_Abbildungen/pds_6_fair_datenideal.pdf")
```
\vspace{.7cm}
...
```{r, echo = FALSE, out.width = "60%"}
knitr::include_graphics("6_Abbildungen/pds_6_binäres_dateiformat.pdf")
```
...
```{r, echo = FALSE, out.width = "60%"}
knitr::include_graphics("6_Abbildungen/pds_6_textuelles_dateiformat.pdf")
```
...
\{
	...
	$\quad\quad\quad\quad$  ``Inferenzstatistik'' : \{``Abgeschlossen'' : FALSE, ``Note'': NA \}
...
knitr::include_graphics("6_Abbildungen/pds_6_r_datasets.pdf")
```
...
knitr::include_graphics("6_Abbildungen/pds_6_writetable.pdf")
```
