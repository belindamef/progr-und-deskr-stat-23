...
knitr::include_graphics("9_Abbildungen/pds_9_otto.png")
```
...
knitr::include_graphics("9_Abbildungen/pds_9_median.pdf")
```
...
bty  = "n")
dev.copy2pdf(
file   = file.path(getwd(), "9_Abbildungen", "pds_9_normalverteilung.pdf"),
width  = 7,
height = 5)
```
...
knitr::include_graphics("9_Abbildungen/pds_9_normalverteilung.pdf")
```
...
bty  = "n")
dev.copy2pdf(
file   = file.path(getwd(), "9_Abbildungen", "pds_9_gleichverteilung.pdf"),
width  = 7,
height = 5)
```
...
\vspace{2mm}
```{r, echo = FALSE, out.width = "80%"}
knitr::include_graphics("9_Abbildungen/pds_9_gleichverteilung.pdf")
```
...
bty  = "n")
dev.copy2pdf(
file   = file.path(getwd(), "9_Abbildungen", "pds_9_bimodalverteilung.pdf"),
width  = 7,
height = 5)
```
...
\vspace{2mm}
```{r, echo = FALSE, out.width = "80%"}
knitr::include_graphics("9_Abbildungen/pds_9_bimodalverteilung.pdf")
```
...
bty  = "n")
dev.copy2pdf(
file   = file.path(getwd(), "9_Abbildungen", "pds_9_gammaverteilung.pdf"),
width  = 7,
height = 5)
```
```{r, echo = FALSE, out.width = "80%"}
knitr::include_graphics("9_Abbildungen/pds_9_gammaverteilung.pdf")
```
...
bty  = "n")
dev.copy2pdf(
file   = file.path(getwd(), "9_Abbildungen", "pds_9_postbdi.pdf"),
width  = 7,
height = 5)
```
