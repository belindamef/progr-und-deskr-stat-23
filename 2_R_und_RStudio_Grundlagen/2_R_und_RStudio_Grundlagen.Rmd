...
\vspace{2mm}
\normalsize Code im .R Skript schreiben (Befehle in Programmiersprache formulieren)  
...
\footnotesize
\justifying
Greta geht ins Schreibwarengeschäft und kauft vier Hefte, zwei Stifte und einen Füller. 
Wie viele analoge Gegenstände kauft Greta insgesamt?
...
Nach Zuweisung existieren die Variablen im Arbeitsspeicher, dem sogenannten \textit{Workspace}
...
2. Führen Sie die Befehlssequenz auf Folie \textcolor{blue}{R Skripte $\vert$ Executing and Editing Code} aus.
