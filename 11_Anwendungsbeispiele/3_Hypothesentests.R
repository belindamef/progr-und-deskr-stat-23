...
x_bar_1   = mean(x_1)                                           # x_bar_1 (Klassisch)
x_bar_2   = mean(x_2)                                           # x_bar_2 (Online)

# Klassisch
# -----------
t_klassisch = sqrt(n_1)*((x_bar_1 - mu_0)/sd(x_1))
...
p_klassisch = 2*(1 - pt(t_klassisch, n_1 - 1))
...
# Online
# -----------
t_online = sqrt(n_2)*((x_bar_2 - mu_0)/sd(x_2))
...
p_online = 2*(1 - pt(t_online, n_1 - 1))
